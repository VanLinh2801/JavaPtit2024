...
public class UserDAO {
    ...
    public void upDate(String username, String fullName, String phone, String gender, int role, int shift, String pass, String old){
    ...
    public static String getPassword2(String username){
        Connection connection = databaseConnector.getConnection();
        ResultSet result;
        String res = "";
